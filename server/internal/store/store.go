...
func (s *Store) migrate() error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS message_deletions (message_id BIGINT NOT NULL, user_id BIGINT NOT NULL, deleted_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY(message_id,user_id), INDEX(user_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`,
